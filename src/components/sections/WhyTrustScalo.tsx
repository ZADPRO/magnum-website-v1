      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 60px auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 2.8rem)', fontWeight: 800, marginBottom: '16px', color: '#0f172a' }}>
            Why Trust <span className="text-gradient">Scalo?</span>
          </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '28px' }}>
          ...
          <div className="glass-card" style={{ padding: '32px', background: '#ffffff' }}>
            ...
            <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#0f172a', marginBottom: '12px' }}>SQMS Measurement System</h3>
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: 1.6 }}>
              Proprietary Scalo Quality Management System aligned with ISO 25010 benchmarks to ensure clear quality tracking and defect prevention.
            </p>
          </div>
